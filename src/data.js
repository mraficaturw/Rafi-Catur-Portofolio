...
export const listProyek = [
  {
    ...
    subtitle: "Intern Seeker website application for Bachelor Degree Students",
    fullDescription:"Website Application for internship seekers, designed to connect students with potential internship opportunities. The platform allows users to create profiles, browse available internships with relevant faculty, and apply directly through the website. It features a user-friendly interface and robust search functionality to help students find internships that match their skills and interests. This project demonstrates my ability to develop full-stack web applications that address real-world needs.",
    borderColor: "#3B82F6",
  ...
  },
  {
    id: 3,
    image: Proyek3,
    title: "Simple Quizz App Application",
    subtitle: "Connect and Using Open Source Quiz API",
    fullDescription:"Fetching Open Source Quiz API with Front-end Reactjs, This project shows my abillity to connect Backend with Reactjs Front-end and make the apllication more powerful.",
    borderColor: "#3B82F6",
    gradient: "linear-gradient(145deg, #3B82F6, #000)",
    url: "https://github.com/mraficaturw",
    dad: "300",
